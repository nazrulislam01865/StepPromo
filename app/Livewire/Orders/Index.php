...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.orders.index', [
            ...
            'ownerFilterOptions' => $options->options($user, 'users', 'order-list-owner', '', $this->filterId($this->owner), 20),
            'stageAssigneeOptions' => $options->options($user, 'users', 'order-list', '', $this->filterId($this->stageAssignee), 20),
            'supplierFilterOptions' => $list->supplierOptions(),
