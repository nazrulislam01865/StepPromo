...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($requestMessage ?? null)): ?>
        <div style="margin:0 0 18px;padding:12px 14px;border-left:3px solid #0b8f80;background:#f1faf8;border-radius:7px;color:#385d58;font-size:12px;line-height:1.55"><?php echo nl2br(e($requestMessage)); ?></div>
