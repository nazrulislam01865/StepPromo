        ...
        <div class="ft-redo-grid">
            <article class="ft-redo-card">
                <header class="ft-redo-cardhead">
                    <h2><?php echo e($isDiscountScope ? ($isMissingQty ? 'Missing quantity adjustment' : 'Customer adjustment relationship') : 'Redo order relationship'); ?></h2>
                    <span class="pill redo"><?php echo e($isDiscountScope ? ($isMissingQty ? 'Missing qty' : 'Adjustment') : '↻ Redo order'); ?></span>
                </header>
                    ...
                    <div class="ft-redo-relation">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDiscountScope): ?>
                            <div class="ft-redo-order-chip current ft-redo-order-chip-static">
                                ...
                                <b><?php echo e($isMissingQty ? 'Missing quantity' : 'Customer adjustment'); ?></b>
                                <span><?php echo e($customerAdjustmentLabel); ?> · <?php echo e(number_format((int) $record->affected_quantity)); ?> affected units</span>
                            </div>
                        <?php else: ?>
                            <button
                                type="button"
...
<?php endif; ?></div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($records->count() > 1): ?>
                        <div class="ft-redo-history-note">
                            This original Order has <?php echo e($records->count()); ?> redo/adjustment records. The newest record is shown here.
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </article>
            ...
            <div class="ft-redo-stack">
                <article class="ft-redo-card">
                    <header class="ft-redo-cardhead"><h2><?php echo e($isDiscountScope ? ($isMissingQty ? 'Missing quantity financial impact' : 'Customer adjustment financial impact') : 'Redo financial impact'); ?></h2></header>
                    <div class="ft-redo-cardbody">
                        <table class="ft-redo-fin-table">
                            <tr><td>Affected value</td><td><?php echo e($money($record->affected_order_value)); ?></td></tr>
                            <tr>
                                <td>Customer · <?php echo e($customerAdjustmentLabel); ?></td>
                ...
                <article class="ft-redo-card">
                    ...
                    <div class="ft-redo-cardbody ft-redo-audit">
                        ...
                        <div class="ft-redo-event">
                            <i></i>
                            <div>
                                <b><?php echo e($isDiscountScope ? ($isMissingQty ? 'Missing quantity approved' : 'Adjustment approved') : 'Redo approved'); ?></b>
                        ...
                        <div class="ft-redo-event">
                            ...
                            <div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDiscountScope): ?>
                                    <b><?php echo e($isMissingQty ? 'Missing quantity deduction recorded' : 'Customer adjustment recorded'); ?></b>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/FlowTracker/resources/views/components/jobs/order-detail/redo-panel.blade.php ENDPATH**/ ?>