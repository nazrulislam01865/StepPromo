...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.create-attachment-dropzone','data' => ['inputId' => 'inquiry-create-attachments','model' => 'createAttachments','multiple' => true,'headline' => 'Drop client files here','browseText' => 'browse files','helper' => 'PDF, Office files, JPG, PNG, ZIP, AI, EPS or ESP · Max 20 MB per file','progressLabel' => 'Uploading files...','progressAriaLabel' => 'Inquiry attachment upload progress']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['input-id' => 'inquiry-create-attachments','model' => 'createAttachments','multiple' => true,'headline' => 'Drop client files here','browse-text' => 'browse files','helper' => 'PDF, Office files, JPG, PNG, ZIP, AI, EPS or ESP · Max 20 MB per file','progress-label' => 'Uploading files...','progress-aria-label' => 'Inquiry attachment upload progress']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
