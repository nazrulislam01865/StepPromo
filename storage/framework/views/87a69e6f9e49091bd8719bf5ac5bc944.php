...
<div
    ...
    x-data="{
        ...
        choose(item) {
            ...
            $wire.call('selectShippingContactOption', <?php echo \Illuminate\Support\Js::from((string) $type)->toHtml() ?>, String(item.id));
        },
        useTypedContact() {
            ...
            this.open = false;
            this.query = '';
            $wire.call('useNewShippingContactPerson', <?php echo \Illuminate\Support\Js::from((string) $type)->toHtml() ?>, name);
        },
    }"
    x-effect="sync(<?php echo \Illuminate\Support\Js::from((string) $value)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from((string) $selectedId)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($items->all())->toHtml() ?>)"
