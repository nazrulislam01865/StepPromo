...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.orders.prototype-list','data' => ['jobs' => $jobs,'rows' => $orderRows,'stages' => $orderStages,'selectedStage' => $selectedStage,'stageQuickFilters' => $stageQuickFilters,'searchFilter' => $search,'clientFilter' => $client,'ownerFilter' => $owner,'phaseFilter' => $phase,'dateFrom' => $dateFrom,'dateTo' => $dateTo,'stageQuick' => $stageQuick,'stageSupplier' => $stageSupplier,'stageAssignee' => $stageAssignee,'stageUrgency' => $stageUrgency,'stageCarrier' => $stageCarrier,'stageClient' => $stageClient,'clientFilterOptions' => $clientFilterOptions,'ownerFilterOptions' => $ownerFilterOptions,'stageAssigneeOptions' => $stageAssigneeOptions,'supplierFilterOptions' => $supplierFilterOptions,'shipmentUrgencyOptions' => $shipmentUrgencyOptions,'importFilterId' => $importBatchId,'importFilterLabel' => $importBatchLabel,'wire:key' => 'orders-prototype-v5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['jobs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($jobs),'rows' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($orderRows),'stages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($orderStages),'selected-stage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedStage),'stage-quick-filters' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageQuickFilters),'search-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($search),'client-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($client),'owner-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($owner),'phase-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($phase),'date-from' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dateFrom),'date-to' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dateTo),'stage-quick' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageQuick),'stage-supplier' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageSupplier),'stage-assignee' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageAssignee),'stage-urgency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageUrgency),'stage-carrier' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageCarrier),'stage-client' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageClient),'client-filter-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientFilterOptions),'owner-filter-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ownerFilterOptions),'stage-assignee-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($stageAssigneeOptions),'supplier-filter-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($supplierFilterOptions),'shipment-urgency-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($shipmentUrgencyOptions),'import-filter-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importBatchId),'import-filter-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($importBatchLabel),'wire:key' => 'orders-prototype-v5']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.jobs.order-detail.workflow-action-modal','data' => ['job' => $listActionOrder,'task' => $listActionTask,'config' => $listActionWorkflowModal,'step' => $orderWorkflowActionStep,'payload' => $orderWorkflowActionPayload]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
