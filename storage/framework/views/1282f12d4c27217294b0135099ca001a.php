...
<?php endif; ?>
    ...
    <dl class="ft-rfq-summary-costs">
        <div><dt>Product subtotal</dt><dd><?php echo e($currency); ?> <?php echo e(number_format((float) $productSubtotal, 2)); ?></dd></div>
        <div><dt>Sample cost</dt><dd><?php echo e($currency); ?> <?php echo e(number_format((float) $sampleCost, 2)); ?></dd></div>
        <div><dt>Other costs</dt><dd><?php echo e($currency); ?> <?php echo e(number_format((float) $otherCosts, 2)); ?></dd></div>
    </dl>
    <div class="ft-rfq-summary-divider"></div>
