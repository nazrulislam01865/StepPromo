...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.create-attachment-dropzone','data' => ['inputId' => 'job-create-purchase-order','model' => 'purchaseOrderUpload','variant' => 'order-document','headline' => 'Drop purchase order here','browseText' => 'browse','browseButton' => 'Browse file','helper' => 'PDF, DOCX, XLSX, JPG or PNG · Max 20 MB','accept' => \App\Support\AttachmentUpload::accept(\App\Support\AttachmentUpload::DOCUMENTS_WITH_AI),'progressLabel' => 'Uploading purchase order...','progressAriaLabel' => 'Purchase order upload progress']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['input-id' => 'job-create-purchase-order','model' => 'purchaseOrderUpload','variant' => 'order-document','headline' => 'Drop purchase order here','browse-text' => 'browse','browse-button' => 'Browse file','helper' => 'PDF, DOCX, XLSX, JPG or PNG · Max 20 MB','accept' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\App\Support\AttachmentUpload::accept(\App\Support\AttachmentUpload::DOCUMENTS_WITH_AI)),'progress-label' => 'Uploading purchase order...','progress-aria-label' => 'Purchase order upload progress']); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="ft-order-document-group ft-order-document-group--other">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canUpload): ?>
                <?php if (isset($component)) { $__componentOriginal6341f0ed212d869a5635165bbc977ad7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6341f0ed212d869a5635165bbc977ad7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.create-attachment-dropzone','data' => ['inputId' => 'job-create-files','model' => 'jobAttachments','multiple' => true,'variant' => 'order-document','headline' => 'Drop supporting files here','browseText' => 'browse','browseButton' => 'Browse files','helper' => 'PDF, DOCX, XLSX, JPG, PNG, ZIP, AI or EPS · Max 20 MB each','accept' => \App\Support\AttachmentUpload::accept(\App\Support\AttachmentUpload::DOCUMENTS_WITH_AI),'progressLabel' => 'Uploading selected files...','progressAriaLabel' => 'Order document upload progress']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.create-attachment-dropzone'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['input-id' => 'job-create-files','model' => 'jobAttachments','multiple' => true,'variant' => 'order-document','headline' => 'Drop supporting files here','browse-text' => 'browse','browse-button' => 'Browse files','helper' => 'PDF, DOCX, XLSX, JPG, PNG, ZIP, AI or EPS · Max 20 MB each','accept' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\App\Support\AttachmentUpload::accept(\App\Support\AttachmentUpload::DOCUMENTS_WITH_AI)),'progress-label' => 'Uploading selected files...','progress-aria-label' => 'Order document upload progress']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
