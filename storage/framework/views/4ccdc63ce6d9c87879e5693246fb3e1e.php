...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showRfqEmailPreview): ?>
                <?php if (isset($component)) { $__componentOriginalaf5ae3db905080150a78d262374b44f1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaf5ae3db905080150a78d262374b44f1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.inquiries-rfq-email-preview','data' => ['previews' => $rfqEmailPreviews,'active' => $rfqEmailPreviewType]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('inquiries-rfq-email-preview'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['previews' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rfqEmailPreviews),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rfqEmailPreviewType)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalaf5ae3db905080150a78d262374b44f1)): ?>
<?php $attributes = $__attributesOriginalaf5ae3db905080150a78d262374b44f1; ?>
<?php unset($__attributesOriginalaf5ae3db905080150a78d262374b44f1); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaf5ae3db905080150a78d262374b44f1)): ?>
<?php $component = $__componentOriginalaf5ae3db905080150a78d262374b44f1; ?>
<?php unset($__componentOriginalaf5ae3db905080150a78d262374b44f1); ?>
<?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCreateDocuments): ?>
                                ...
                                >
                                    ...
                                    <label class="ft-inquiry-task-document-dropzone ft-inquiry-attachment-dropzone <?php echo e($taskDocumentUpload ? 'is-compact' : ''); ?>">
                                        <input type="file" wire:model="taskDocumentUpload" accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png,.zip,.txt,.csv,.ai,.eps,.esp" aria-label="<?php echo e($taskDocumentUpload ? 'Add another file' : 'Choose a file to upload'); ?>">
